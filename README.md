...
A10, Session2, IAEA-C1,   6.21937, 11.44701,  17.26426,  24.84678,  0.76866
```
...
#### Option 2: based on the known composition of a sample:
...
for k in foo.sessions['Session1']:
    if k == 'data':
        print(f"{k}: [...] (too large to print)")
    else:
        print(f"{k}: {foo.sessions['Session1'][k]}")
# output:
